...
include {ELIMINATE_REDUNDANCE   as ELIMINATE_REDUNDANCE_1           } from '../../modules/local/cd-hit/cd-hit-est-repetitive-elements'
include {ELIMINATE_REDUNDANCE   as ELIMINATE_REDUNDANCE_2           } from '../../modules/local/cd-hit/cd-hit-est-repetitive-elements'
...
// include {PROCESS_REPEATS                                            } from '../../modules/local/repeatmasker/repeatmasker-post-process'
