...
include {ELIMINATE_REDUNDANCE_1         } from '../../modules/local/repeatmodeler2/eliminate_redundance'
include {ELIMINATE_REDUNDANCE_2         } from '../../modules/local/repeatmodeler2/eliminate_redundance'
include {REPEATMASKER_WITH_EXISTING_LIB } from '../../modules/local/repeatmasker/repeatmasker'
include {REPEATMASKER_WITH_OWN_LIB_1    } from '../../modules/local/repeatmasker/repeatmasker'
include {REPEATMASKER_WITH_OWN_LIB_2    } from '../../modules/local/repeatmasker/repeatmasker'
...
workflow REPETITIVE_ELEMENTS{
    ...
    main:
        ...
        if ( params.repeats_split ) {
            LIBRAIRY_SPLIT(ch_RM2_library)
            ELIMINATE_REDUNDANCE_1(LIBRAIRY_SPLIT.out.classified)
            ELIMINATE_REDUNDANCE_2(LIBRAIRY_SPLIT.out.unclassified)
        }
        else {
